...
const transformers: Record<string, TransformerInformation> = {
  activity: {
    name: 'Activity',
    proprieties: {
      join: { type: 'string', optional: true },
      flags: { type: 'number', optional: true },
      applicationId: { type: 'bigint', optional: true },
      spectate: { type: 'string', optional: true },
      url: { type: 'string', optional: true },
      startedAt: { type: 'number', optional: true },
      ...
      partyCurrentSize: { type: 'number', optional: true },
      partyMaxSize: { type: 'number', optional: true },
      largeImage: { type: 'string', optional: true },
      largeText: { type: 'string', optional: true },
      smallImage: { type: 'string', optional: true },
      smallText: { type: 'string', optional: true },
      match: { type: 'string', optional: true },
      instance: { type: 'boolean', optional: true },
      buttons: {
        type: { url: { type: 'string' }, label: { type: 'string' } },
        optional: true,
        array: true,
      },
      name: { type: 'string' },
      type: { type: 'import("@discordeno/types").ActivityTypes' },
  ...
  application: {
    ...
    proprieties: {
      ...
      icon: { type: 'bigint', optional: true },
      rpcOrigins: { type: 'string', array: true, optional: true },
      termsOfServiceUrl: { type: 'string', optional: true },
      privacyPolicyUrl: { type: 'string', optional: true },
      primarySkuId: { type: 'string', optional: true },
      slug: { type: 'string', optional: true },
      coverImage: { type: 'bigint', optional: true },
      owner: { type: 'User', optional: true },
      team: { type: 'Team', optional: true },
      guildId: { type: 'bigint', optional: true },
      guild: { type: 'Guild', optional: true },
      id: { type: 'bigint' },
      name: { type: 'string' },
      description: { type: 'string' },
      botPublic: { type: 'boolean' },
      botRequireCodeGrant: { type: 'boolean' },
      verifyKey: { type: 'string' },
      approximateGuildCount: { type: 'number', optional: true },
      bot: { type: 'User', optional: true },
      redirectUris: { type: 'string', optional: true, array: true },
      interactionsEndpointUrl: { type: 'string', optional: true },
    },
  },
  applicationCommand: {
    name: 'ApplicationCommand',
    proprieties: {
      options: { type: 'ApplicationCommandOption', optional: true, array: true },
      ...
      defaultMemberPermissions: { type: 'bigint', optional: true },
      type: {
  ...
  applicationCommandOption: {
    ...
    proprieties: {
      ...
      description: { type: 'string', comment: '1-100 character description' },
      descriptionLocalizations: {
        type: 'import("@discordeno/types").Localization',
        optional: true,
  ...
  attachment: {
    name: 'Attachment',
    proprieties: {
      filename: { type: 'string', comment: 'Name of file attached' },
      contentType: {
        type: 'string',
        optional: true,
        comment: "The attachment's [media type](https://en.wikipedia.org/wiki/Media_type)",
      },
      size: { type: 'number', comment: 'Size of file in bytes' },
      url: { type: 'string', comment: 'Source url of file' },
      proxyUrl: { type: 'string', comment: 'A proxied url of file' },
      id: { type: 'bigint', comment: 'Attachment id' },
      description: {
        type: 'string',
        optional: true,
  ...
  auditLogEntry: {
    ...
    proprieties: {
      id: { type: 'bigint' },
      userId: { type: 'bigint', optional: true },
      ...
      targetId: { type: 'bigint', optional: true },
      actionType: { type: 'import("@discordeno/types").AuditLogEvents' },
      options: {
        type: {
          id: { type: 'bigint', optional: true },
          channelId: { type: 'bigint', optional: true },
          messageId: { type: 'bigint', optional: true },
          type: { type: 'number' },
          count: { type: 'number' },
          deleteMemberDays: { type: 'number' },
          membersRemoved: { type: 'number' },
          roleName: { type: 'string' },
          autoModerationRuleName: { type: 'string' },
          autoModerationRuleTriggerType: { type: 'string' },
  ...
  autoModerationActionExecution: {
    ...
    proprieties: {
      channelId: { type: 'bigint', optional: true },
      messageId: { type: 'bigint', optional: true },
      alertSystemMessageId: { type: 'bigint', optional: true },
      guildId: { type: 'bigint' },
      userId: { type: 'bigint' },
      content: { type: 'string' },
      action: {
  ...
  autoModerationRule: {
    ...
    proprieties: {
      triggerMetadata: {
        type: {
          keywordFilter: { type: 'string', optional: true, array: true },
          presets: {
            type: 'import("@discordeno/types").DiscordAutoModerationRuleTriggerMetadataPresets',
            optional: true,
            array: true,
          },
          allowList: { type: 'string', optional: true, array: true },
          mentionTotalLimit: { type: 'number', optional: true },
          regexPatterns: { type: 'string', array: true },
        },
        optional: true,
      },
      id: { type: 'bigint' },
      name: { type: 'string' },
      guildId: { type: 'bigint' },
      eventType: { type: 'import("@discordeno/types").AutoModerationEventTypes' },
      triggerType: {
        type: 'import("@discordeno/types").AutoModerationTriggerTypes',
      },
      enabled: { type: 'boolean' },
      creatorId: { type: 'bigint' },
      exemptRoles: { type: 'bigint', array: true },
      exemptChannels: { type: 'bigint', array: true },
      actions: {
        type: {
          type: {
            type: 'import("@discordeno/types").AutoModerationActionType',
  ...
  channel: {
    name: 'Channel',
    proprieties: {
      id: { type: 'bigint', comment: 'The id of the channel' },
      toggles: {
      ...
      nsfw: { type: 'boolean', comment: 'Whether the channel is nsfw' },
      threadMetadata: {
        type: {
          archiveTimestamp: {
            type: 'number',
      ...
      archived: { type: 'boolean', comment: 'Whether the thread is archived' },
  ...
  component: {
    ...
    proprieties: {
      ...
      emoji: {
        type: {
          id: { type: 'bigint', optional: true, comment: 'Emoji id' },
          animated: {
            type: 'boolean',
            optional: true,
            comment: 'Whether this emoji is animated',
          },
          name: { type: 'string', optional: true, comment: 'Emoji name' },
        },
        optional: true,
  ...
  embed: {
    ...
    proprieties: {
      ...
      image: {
        type: {
          url: { type: 'string' },
          proxyUrl: { type: 'string', optional: true },
      ...
      footer: {
        type: {
          ...
          proxyIconUrl: { type: 'string', optional: true },
          text: { type: 'string' },
        },
        optional: true,
      },
  ...
  emoji: {
    ...
    proprieties: {
      ...
      toggles: { type: 'import("@discordeno/bot").EmojiToggles' },
    },
  },
  entitlement: {
    name: 'Entitlement',
    proprieties: {
      id: { type: 'bigint', comment: 'ID of the entitlement' },
      skuId: { type: 'bigint', comment: 'ID of the SKU' },
      userId: {
        type: 'bigint',
        optional: true,
      ...
      applicationId: { type: 'bigint', comment: 'ID of the parent application' },
      type: {
        type: 'import("@discordeno/types").DiscordEntitlementType',
        comment: 'Type of entitlement',
      },
      deleted: { type: 'boolean', comment: 'Entitlement was deleted' },
      startsAt: {
        type: 'number',
        optional: true,
  ...
  guild: {
    ...
    proprieties: {
      ...
      toggles: { type: 'import("@discordeno/bot").GuildToggles' },
      shardId: { type: 'number' },
      premiumTier: {
      ...
      id: { type: 'bigint', comment: 'Guild id' },
      icon: { type: 'bigint', optional: true, comment: 'Icon hash' },
      iconHash: {
        type: 'bigint',
        optional: true,
        comment: 'Icon hash, returned when in the template object',
      },
      splash: { type: 'bigint', optional: true, comment: 'Splash hash' },
      discoverySplash: {
        type: 'bigint',
        optional: true,
        comment: 'Discovery splash hash; only present for guilds with the "DISCOVERABLE" feature',
      },
      ownerId: { type: 'bigint', comment: 'Id of the owner' },
      permissions: {
        type: 'bigint',
        comment: 'Total permissions for the user in the guild (excludes overwrites and implicit permissions)',
      },
      afkChannelId: { type: 'bigint', optional: true, comment: 'Id of afk channel' },
      widgetChannelId: {
        type: 'bigint',
        optional: true,
      ...
      banner: { type: 'bigint', optional: true, comment: 'Banner hash' },
      preferredLocale: {
        type: 'string',
  ...
  integration: {
    ...
    proprieties: {
      ...
      syncing: { type: 'boolean', optional: true },
      roleId: { type: 'bigint', optional: true },
      enableEmoticons: { type: 'boolean', optional: true },
      expireBehavior: {
        type: 'import("@discordeno/types").IntegrationExpireBehaviors',
        optional: true,
      },
      expireGracePeriod: { type: 'number', optional: true },
      syncedAt: { type: 'number', optional: true },
      subscriberCount: { type: 'number', optional: true },
      revoked: { type: 'boolean', optional: true },
      application: {
        type: {
          bot: { type: 'User', optional: true },
          icon: { type: 'bigint', optional: true },
  ...
  interaction: {
    ...
    proprieties: {
      ...
      id: { type: 'bigint', comment: 'Id of the interaction' },
      applicationId: {
        type: 'bigint',
      ...
      version: { type: '1', comment: 'Read-only property, always `1`' },
      message: {
        type: 'Message',
        optional: true,
      ...
      data: {
        type: {
          ...
          components: { type: 'Component', optional: true, array: true },
          values: { type: 'string', optional: true, array: true },
          name: { type: 'string' },
          resolved: { type: 'InteractionDataResolved', optional: true },
          options: {
  ...
  invite: {
    name: 'Invite',
    proprieties: {
      channelId: { type: 'bigint', comment: 'The channel the invite is for' },
      code: { type: 'string', comment: 'The unique invite code' },
      createdAt: {
        type: 'number',
      ...
      targetUser: { type: 'User', comment: 'The target user for this invite' },
      targetApplication: {
        type: 'Application',
        optional: true,
  ...
  member: {
    name: 'Member',
    proprieties: {
      id: { type: 'bigint', comment: 'The user id of the member.' },
      toggles: {
        type: 'import("@discordeno/bot").MemberToggles',
        optional: true,
        comment: 'The compressed form of all the boolean values on this user.',
      },
      guildId: { type: 'bigint', comment: 'The guild id where this member is.' },
      user: {
        type: 'User',
        optional: true,
      ...
      joinedAt: { type: 'number', comment: 'When the user joined the guild' },
      premiumSince: {
        type: 'number',
        optional: true,
  ...
  message: {
    ...
    proprieties: {
      ...
      pinned: { type: 'boolean', comment: 'Whether this message is pinned' },
      ...
      tts: { type: 'boolean', comment: 'Whether this was a TTS message.' },
      urgent: {
        type: 'boolean',
      ...
      content: { type: 'string', comment: 'Contents of the message' },
      editedTimestamp: {
        type: 'number',
        optional: true,
      ...
      id: { type: 'bigint', comment: 'id of the message' },
      interaction: {
        type: {
          id: { type: 'bigint', comment: 'Id of the interaction' },
          member: {
      ...
      reactions: {
        type: {
          ...
          countDetails: {
            type: {
              burst: { type: 'number', comment: 'Count of super reactions' },
              normal: { type: 'number', comment: 'Count of normal reactions' },
            },
            comment: 'Reaction count details object',
          },
          emoji: { type: 'Emoji', comment: 'Emoji information' },
          burstColors: {
            type: 'string',
            array: true,
      ...
      stickerItems: {
        type: {
          id: { type: 'bigint', comment: 'The id of this sticker.' },
          name: { type: 'string', comment: 'The name of this sticker.' },
          formatType: {
  ...
  guildOnboardingPrompt: {
    ...
    proprieties: {
      id: { type: 'bigint', comment: 'ID of the prompt' },
      type: {
      ...
      title: { type: 'string', comment: 'Title of the prompt' },
      singleSelect: {
        type: 'boolean',
  ...
  guildOnboardingPromptOption: {
    ...
    proprieties: {
      id: { type: 'bigint', comment: 'ID of the prompt option' },
      channelIds: {
        type: 'bigint',
        array: true,
  ...
  presenceUpdate: {
    name: 'PresenceUpdate',
    proprieties: {
      desktop: { type: 'string', optional: true },
      mobile: { type: 'string', optional: true },
      web: { type: 'string', optional: true },
      user: { type: 'User' },
      guildId: { type: 'bigint' },
      status: { type: 'import("@discordeno/types").PresenceStatus' },
      activities: { type: 'Activity', array: true },
    },
  },
  role: {
    name: 'Role',
    proprieties: {
      ...
      id: { type: 'bigint', comment: 'Role id' },
      guildId: {
        type: 'bigint',
      ...
      permissions: { type: 'import("@discordeno/bot").Permissions', comment: 'Permission bit set' },
      managed: {
        type: 'boolean',
        comment: 'Whether this role is managed by an integration',
      },
      mentionable: { type: 'boolean', comment: 'Whether this role is mentionable' },
      internalTags: {
        type: {
          botId: {
            type: 'bigint',
      ...
      name: { type: 'string', comment: 'Role name' },
      color: {
        type: 'number',
        comment: 'Integer representation of hexadecimal color code',
      },
      position: { type: 'number', comment: 'Position of this role' },
      unicodeEmoji: { type: 'string', optional: true, comment: 'role unicode emoji' },
      flags: {
  ...
  scheduledEvent: {
    name: 'ScheduledEvent',
    proprieties: {
      id: { type: 'bigint', comment: 'the id of the scheduled event' },
      guildId: {
        type: 'bigint',
      ...
      name: { type: 'string', comment: 'the name of the scheduled event' },
      description: {
        type: 'string',
        optional: true,
  ...
  sku: {
    name: 'Sku',
    proprieties: {
      id: { type: 'bigint', comment: 'ID of SKU' },
      type: {
  ...
  stageInstance: {
    ...
    proprieties: {
      ...
      id: { type: 'bigint', comment: 'The id of this Stage instance' },
      guildId: {
        type: 'bigint',
  ...
  inviteStageInstance: {
    ...
    proprieties: {
      ...
      participantCount: { type: 'number', comment: 'The number of users in the Stage' },
      speakerCount: {
        type: 'number',
  ...
  sticker: {
    ...
    proprieties: {
      ...
      name: { type: 'string', comment: 'Name of the sticker' },
      description: { type: 'string', comment: 'Description of the sticker' },
      tags: {
        type: 'string',
  ...
  stickerPack: {
    name: 'StickerPack',
    proprieties: {
      coverStickerId: { type: 'bigint', optional: true },
      bannerAssetId: { type: 'bigint', optional: true },
      id: { type: 'bigint' },
      name: { type: 'string' },
      description: { type: 'string' },
      stickers: { type: 'Sticker', array: true },
      skuId: { type: 'bigint' },
    },
  },
  team: {
    ...
    proprieties: {
      ...
      members: {
        type: {
          membershipState: { type: 'import("@discordeno/types").TeamMembershipStates' },
          teamId: { type: 'bigint' },
          user: { type: 'User' },
          role: { type: 'import("@discordeno/types").DiscordTeamMemberRole' },
        },
        array: true,
      },
    },
  ...
  threadMember: {
    ...
    proprieties: {
      ...
      userId: { type: 'bigint', optional: true },
      flags: { type: 'number' },
      joinTimestamp: { type: 'number' },
    },
  },
  threadMemberGuildCreate: {
    name: 'ThreadMemberGuildCreate',
    proprieties: { joinTimestamp: { type: 'number' } },
  },
  user: {
    name: 'User',
    proprieties: {
      ...
      id: { type: 'bigint', comment: "The user's id" },
      discriminator: { type: 'string', comment: "The user's discord-tag" },
      avatar: {
        type: 'bigint',
        optional: true,
        comment: "The user's avatar hash",
      },
      email: { type: 'string', optional: true, comment: "The user's email" },
      banner: {
        type: 'bigint',
        optional: true,
  ...
  voiceState: {
    name: 'VoiceState',
    proprieties: {
      requestToSpeakTimestamp: { type: 'number', optional: true },
      channelId: { type: 'bigint', optional: true },
      guildId: { type: 'bigint' },
      toggles: { type: 'import("@discordeno/bot").VoiceStateToggles' },
  ...
  webhook: {
    ...
    proprieties: {
      ...
      id: { type: 'bigint', comment: 'The id of the webhook' },
      guildId: {
        type: 'bigint',
        optional: true,
    ...
    proprieties: {
      ...
      welcomeChannels: {
        type: {
          ...
          description: { type: 'string' },
          emojiId: { type: 'bigint', optional: true },
          emojiName: { type: 'string', optional: true },
        },
        array: true,
      },
    },
    ...
    proprieties: {
      ...
      members: {
        type: {
          ...
          avatar: { type: 'bigint', optional: true },
          status: { type: 'string' },
